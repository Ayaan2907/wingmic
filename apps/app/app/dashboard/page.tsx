    ...
    >
      <div style={{ maxWidth: 480, textAlign: 'center' }}>
        ...
        <p style={{ marginTop: 14, color: 'var(--text-55)', fontSize: 15, lineHeight: 1.55 }}>
          go to <a href="/chat?armRecord=1" style={{ color: '#FFC452', textDecoration: 'underline' }}>/chat</a> or <a href="/recall" style={{ color: '#FFC452', textDecoration: 'underline' }}>/recall</a>.
        </p>
      </div>
    </main>
  );
